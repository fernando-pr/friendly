                    ...
                    $items = [
                        ...
                        Yii::$app->user->isGuest ? (
                            ['label' => 'Login', 'url' => ['/site/login']]
                                ...
                                . '<div class="fotos_login">'
                                . Html::a(
                                    '<img src="/img/grupo.png" width="37" height="37", class="img-circle">',
                                    ['publicos/publicos'],
                                    ['class' => 'img-circle', 'title'=>'chat grupo']
                                    ) . ' '
                                    . Html::a(
                                        '<img src="/img/chat.png" width="37" height="37", class="img-circle">',
                                        ['privados/privados'],
                                        ['class' => 'img-circle', 'title'=>'chat']
                                        ) . ' '
                                        . Html::a(
                                            '<img src="/img/amistad.jpg" width="37" height="37", class="img-circle">',
                                            ['amigos/amigos'],
                                            ['class' => 'img-circle', 'title'=>'Amigos']
                                            ) . ' '
                                            . Html::a(
                                                '<img src="/img/peticion.png" width="37" height="37", class="img-circle">',
                                                ['usuarios/peticiones'],
                                                ['class' => 'img-circle', 'title'=>'Peticiones Amistad']
                                                ) . ' '
                                                . Html::a(
                                                    '<img src="/' . $ruta . '" width="37" height="37", class="img-circle">',
                                                    ['usuarios/view/' . Yii::$app->user->id],
                                                    ['class' => 'img-circle', 'title'=>'perfil ' . Yii::$app->user->identity->nombre]
                                                    ) . ' '
                                                    . Html::submitButton(
                                                        '<img src="/encendido.png" width="37" height="37" title="Cerrar Sesión">',
                                                        ['class' => 'btn btn-link logout']

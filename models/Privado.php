...
class Privado extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    public function getMensajesUsuario($id_amigo)
    {
        ...
        $mensajes = Privado::findBySql('SELECT * FROM privados where (id_emisor = ' . $id_mio . 'and id_receptor = ' . $id_amigo . ') or (id_emisor = ' . $id_amigo . 'and id_receptor = ' . $id_mio . ') order by id DESC limit 50')->all();
